	...
	public void searchFriend() {	
		...
		if (search_text.equals("")) {
			...
			try{
				...
				Toast.makeText(FriendAddActivity.this,e.getMessage()+"服务器连接异常"+e.getClass().toString(), Toast.LENGTH_SHORT).show();
			}
						...
						dialog.setTitle("添加好友")
						      ...
						      .setPositiveButton("确定", new DialogInterface.OnClickListener() {
					                     ...
					                     public void onClick(DialogInterface dialog, int which) {		 
				                    	     ...
				                    	     dialog.cancel();//取消弹出框
				                    	     finish();
					                    	 Toast.makeText(FriendAddActivity.this,"成功添加好友："+userName, Toast.LENGTH_SHORT).show();

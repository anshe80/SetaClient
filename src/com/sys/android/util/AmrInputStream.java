...
public final class AmrInputStream extends InputStream {
	...
	protected void finalize() throws Throwable {
		if (mGae != 0) {
			...
			throw new IllegalStateException(
					"someone forgot to close AmrInputStream");
		}
	}
	...
	private static native int GsmAmrEncoderEncode(int gae, byte[] pcm,
			int pcmOffset, byte[] amr, int amrOffset) throws IOException;
